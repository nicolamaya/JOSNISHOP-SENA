    ...
    <div>
      ...
      <div className="producto-container">
        ...
        <div className="producto-info">
          <h2>
            Chubasquero con cara para perros, mono impermeable, Chaqueta
          </h2>
          <div className="precio">$19.779 COP</div>
          <button
        ...
        <div className="lateral">
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "10px" }}>
            <label htmlFor="cantidad-perro" style={{ margin: 0 }}>Cantidad:</label>
            <input
              type="number"
              id="cantidad-perro"
              min={1}
          ...
          <div style={{ display: "flex", justifyContent: "flex-start" }}>
            <button
              ...
              onClick={() => {
                ...
                const cantidad = parseInt((document.getElementById("cantidad-perro") as HTMLInputElement).value) || 1;
