    ...
    <div>
      ...
      <div className="producto-container">
        <div className="producto-imagen">
          <img src="/src/assets/IMG/index/lienzo.jpg" alt="Lienzo para pintar" />
        </div>
        <div className="producto-info">
          <h2>
            Lienzo Bastidor 12 X 18 Cm En Caballete En Madera 280g/m2.
          </h2>
          <div className="precio">$17.990 COP</div>
          <button
          ...
          <div className="estrellas">★★★★★ 4.6</div>
          <p className="detalle">Productos Disponibles: 60</p>
        </div>
        <div className="lateral">
          <p><strong>Vendido por:</strong> LienzoStore</p>
          <p><strong>Envío:</strong> COP$2,500.00</p>
          <p><strong>Entrega:</strong> 13 de JUN.</p>
          <p>✔ Política de devoluciones y reembolsos</p>
          <p>✔ Seguridad & Privacidad</p>
          <div style={{ display: "flex", alignItems: "center", gap: "8px", marginBottom: "10px" }}>
            <label htmlFor="cantidad-lienzo" style={{ margin: 0 }}>Cantidad:</label>
            <input
              type="number"
              id="cantidad-lienzo"
              min={1}
          ...
          <div style={{ display: "flex", justifyContent: "flex-start" }}>
            <button
              ...
              onClick={() => {
                ...
                const cantidad = parseInt((document.getElementById("cantidad-lienzo") as HTMLInputElement).value) || 1;
                const producto: ProductoCarrito = {
                  id: 66,
                  nombre: "Lienzo decorativo",
                  precio: 39999,
      ...
      {showVideos && (
        <div id="videosContainer" className="videos-container">
          <video controls>
            <source src="/src/assets/videos/index/lienzo/video1.mp4" type="video/mp4" />
